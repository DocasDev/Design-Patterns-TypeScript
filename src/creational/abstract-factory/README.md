...
Imagine essa hierarquia descrita assim (se preferir diagramas, veja a pasta diagrams):
...
Observação importante: objetos criados por um fábricas tendem a ser chamados de "Product" (produto). Veja os diagramas na pasta "diagrams" para melhor entendimento.
